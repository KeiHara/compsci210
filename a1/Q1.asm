...
MyDIV	ADD R1, R7, #0
      JSR Push ; saving R7 to stack
      ADD R1, R0, #0 
      JSR Push ; Saving R0 to stack
      AND R0, R0, #0 ; R0 to zero
      NOT R3, R3
      ADD R3, R3, #1 ; R3 to negative
DIVLOOP   ADD R0, R0, #1 
          ADD R2, R2, R3
      ...
      ADD R0, R0, #-1
      ADD R3, R0, #0
      JSR Pop ; Retrieving R1 from stack
      ADD R0, R1, #0
      JSR Pop 
      ADD R7, R1, #0
			RET
...
MyPOW	ADD R1, R7, #0
      ...
      ADD R3, R3, #-1 ; r3 = 1
      BRz RESULT
OUTLOOP   ADD R4, R2, #-1 ; r4 = 7
          BRnz RESULT
          ADD R0, R5, #0
INNLOOP   ADD R5, R5, R0 ; r5 = 16, 24, 32, 40, 48, 56, 64
          ADD R4, R4, #-1; r4 = 6, 5, 4, 3, 2, 1, 0
          BRp INNLOOP
          ADD R3, R3, #-1; R3 = 0
          BRp OUTLOOP
RESULT  ADD R3, R5, #0
